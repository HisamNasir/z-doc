...
const SubMenu: React.FC<SubMenuProps> = ({ items }) => {
  return (
    <div className=" p-2 pr-3 cursor-default flex flex-col justify-between pb-9 w-full h-full text-white relative ">
      ...
      <button className="hover:opacity-80  fixed bottom-4 hover:text-blue-400 transition-all duration-500 right-4 uppercase text-xs tracking-widest flex items-center gap-2">
